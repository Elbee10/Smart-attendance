                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('student-registration')}}" method ="post">
                            ...
                            <div class="form-group row">
                                <div class="col-md-4 col-form-label text-md-right" for="studentID">studentID</div>
                                <div class="col-md-6">
                                    <input type="text" id="studentID" name="studentID" class="form-control" required autofocus
                                    value="{{old("studentID") }}">
                            ...
                            <div class="form-group row">
                                <div class="col-md-4 col-form-label text-md-right" for="dob">Department</div>
                                <div class="col-md-6">
                            ...
                            <div class="col-md-6 offset-md-4">
                                    ...
                                    <a href="{{route('login-student')}}" class="btn btn-link">
